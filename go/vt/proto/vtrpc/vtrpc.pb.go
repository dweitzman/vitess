...
func (Code) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_vtrpc_35f0bfef97a8aff5, []int{0}
}
...
func (LegacyErrorCode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_vtrpc_35f0bfef97a8aff5, []int{1}
}
...
func init() { proto.RegisterFile("vtrpc.proto", fileDescriptor_vtrpc_35f0bfef97a8aff5) }

var fileDescriptor_vtrpc_35f0bfef97a8aff5 = []byte{
