...
func init() {
	proto.RegisterFile("automationservice.proto", fileDescriptor_automationservice_95001c12895207f6)
}

var fileDescriptor_automationservice_95001c12895207f6 = []byte{
