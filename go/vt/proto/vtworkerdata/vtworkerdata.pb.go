...
func (*ExecuteVtworkerCommandRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_vtworkerdata_a4e9c8fe7d2eb5e8, []int{0}
}
...
func (*ExecuteVtworkerCommandResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_vtworkerdata_a4e9c8fe7d2eb5e8, []int{1}
}
...
func init() { proto.RegisterFile("vtworkerdata.proto", fileDescriptor_vtworkerdata_a4e9c8fe7d2eb5e8) }

var fileDescriptor_vtworkerdata_a4e9c8fe7d2eb5e8 = []byte{
